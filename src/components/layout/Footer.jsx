      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-16">
          ...
          <div>
            ...
            >
              <span className="flex items-center justify-center w-9 h-9 rounded-full bg-[var(--color-primary)] text-white font-bold font-display text-sm shrink-0">
                RM
              </span>
              <span className="font-display font-bold text-white text-lg group-hover:text-[var(--color-primary)] transition-colors duration-200">
                Roberto Mattus
              </span>
            </a>
        ...
        {/* ── Divider ── */}
        <div className="mt-12 mb-6 h-px bg-[#333333]" aria-hidden="true" />
